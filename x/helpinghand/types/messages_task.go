...
func NewMsgCreateTask(creator string, title string, description string, prize int32, startedAt string, endedAt string) *MsgCreateTask {
...
func NewMsgUpdateTask(creator string, id uint64, title string, description string, prize int32, startedAt string, endedAt string) *MsgUpdateTask {
